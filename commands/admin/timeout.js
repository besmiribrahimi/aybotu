    ...
    try {
      ...
      try {
        const dmEmbed = new EmbedBuilder()
          .setColor('#748FFC')
          .setTitle('˚ ༘♡ ⋆˙ You have been timed out ⋆˙♡ ༘˚')
          .setDescription(`✧˖°. ——————— .°˖✧\n\nYou have been timed out in **${interaction.guild.name}**`)
          .addFields(
            { name: '꒰ა Duration ჲ꒱', value: duration, inline: true },
            { name: '꒰ა Reason ჲ꒱', value: reason, inline: false }
          )
          .setFooter({ text: '˖ ᡣ𐭔.° Please be patient~' })
          .setTimestamp();
      ...
      const embed = new EmbedBuilder()
        .setColor('#748FFC')
        .setTitle('˚ ༘♡ ⋆˙ User Timed Out ⋆˙♡ ༘˚')
        .setDescription(`✧˖°. ——————— .°˖✧\n\n**${user.tag}** has been timed out.`)
        .addFields(
          { name: '꒰ა User ჲ꒱', value: `${user.tag}`, inline: true },
          { name: '꒰ა Duration ჲ꒱', value: duration, inline: true },
          { name: '꒰ა Reason ჲ꒱', value: reason, inline: false }
        )
        .setFooter({ text: '˖ ᡣ𐭔.° Moderation Action' })
        .setTimestamp();
