...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription(`୨୧ ⏔⏔⏔⏔♡⏔⏔⏔⏔ ୨୧\n\n　　　　　　𓂃 ִֶָ𐀔　Moderation History　𓂃 ִֶָ𐀔`)
      .addFields(
        { name: '⊹ ࣪✧ User ˖ °', value: `${user.tag}\n\`${user.id}\``, inline: true },
        { name: '⊹ ࣪✧ Bans ˖ °', value: `⛔ ${bans}`, inline: true },
        { name: '⊹ ࣪✧ Kicks ˖ °', value: `👢 ${kicks}`, inline: true },
        { name: '⊹ ࣪✧ Warns ˖ °', value: `⚠️ ${warns}`, inline: true },
        { name: '⊹ ࣪✧ Mutes/Timeouts ˖ °', value: `🔇 ${mutes} (⏰ ${timeouts} timeouts)`, inline: true },
        { name: '⊹ ࣪✧ Total Actions ˖ °', value: `${actions.length}`, inline: true }
      )
      .setThumbnail(user.displayAvatarURL({ dynamic: true }))
      .setFooter({ text: '୭ ˚. ᵎᵎ 🍥 °  Aylina\'s Disc — User moderation summary' })
      .setTimestamp();
